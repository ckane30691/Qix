...
class MovingObject {
	...
	move(timeDelta) {
		...
		//       if (direction === 'right' && this.isValidMove([this.pos[0] + 1, this.pos[1]]) !== true) {
		...
		//     } break;
		//     case 'down':
		//       if (direction === 'down' && this.isValidMove([this.pos[0], this.pos[1] + 1]) !== true) {
		//         console.log("OFFTRACK DOWN", this.pos);
		//         if (this.findNextMove(this.pos, direction) === 'right') {
		//           console.log("ontrack right");
		//           this.vel[0] = 1;
		//           this.vel[1] = 0;
		//           break;
		...
		//       } break;
		//     case 'left':
		//       if (direction === 'left' && this.isValidMove([this.pos[0] - 1, this.pos[1]]) !== true) {
		//         console.log("IMPORTANT",this.findNextMove(this.pos));
		//         if (this.findNextMove(this.pos) === 'down') {
		//           this.vel[0] = 0;
		//           this.vel[1] = 1;
		//           console.log("ontrack down", this.pos);
		//           break;
...
class Game {
	...
	isOutOfBounds(pos) {
		return pos[0] < 55 || pos[1] < 55 || pos[0] > Game.DIM_X - 55 || pos[1] > Game.DIM_Y - 55;
	}
	...
	shipRandomPos() {
		return [ Math.floor(Math.random() * 900 - 200 + 200), 54 ];
	}
